    ...
    return (
        <>
            <Head>
                ...
                <title>Register - Smart Card Generator</title>
                <meta property="og:type" content="website" />
                <meta
                    property="og:url"
                    content="https://smartcardgenerator.net/register"
                />
                <meta
                ...
                <meta
                    property="og:title"
                    content="Register - Smart Card Generator"
                />
                <meta
                    property="og:image"
                    content="/img/meta_image/register.jpg"
                />
                <meta property="image" content="/img/meta_image/register.jpg" />
                ...
                <AuthCard
                    ...
                    <div className="login-wrapper">
                        <form onSubmit={submitForm}>
                            ...
                            <div className="mt-3">
                                <label
                                    ...
                                    <input
                                        ...
                                        type="checkbox"
                                        name=""
                                        className="rounded border-gray-300 text-yellow-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                    />

                                    <p className="ml-2 text-sm text-gray-600">
                                        I agree with the{' '}
                                        <span className="forget-text-color">
                            ...
                            <h2 className="login-head-text mt-3">
